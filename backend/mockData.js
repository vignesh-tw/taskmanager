...
const mockTherapists = [
  ...
  },
  {
    ...
    specializations: ["Marriage Counseling", "Family Therapy", "Relationship Issues"],
  ...
  },
  {
    ...
    specializations: ["PTSD Treatment", "Trauma Therapy", "Military & Veteran Support"],
    profilePicture: "https://images.unsplash.com/photo-1594824531860-1fa2c835bd90?w=400&h=400&fit=crop&crop=face",
    languages: ["English", "Spanish"],
    location: "Austin, TX",
  ...
  },
  {
    ...
    specializations: ["Addiction Counseling", "Substance Abuse", "Group Therapy"],
  ...
  },
  {
    ...
    specializations: ["Child Psychology", "Adolescent Therapy", "Family Therapy"],
  ...
  },
  {
    ...
    specializations: ["Anxiety Treatment", "Panic Disorders", "Mindfulness-Based Therapy"],
    profilePicture: "https://images.unsplash.com/photo-1607990281513-2c110a25bd8c?w=400&h=400&fit=crop&crop=face",
...
const generateTimeSlots = (therapistId, daysAhead = 30) => {
  ...
  for (let day = 1; day <= daysAhead; day++) {
    ...
    if (therapistId === "therapist_2" && (date.getDay() === 0 || date.getDay() === 6)) {
      continue;
    }
    ...
    for (let i = 0; i < slotsPerDay; i++) {
      ...
      slots.push({
        ...
        duration: 60,
        price: mockTherapists.find(t => t.id === therapistId)?.sessionPrice || 150,
