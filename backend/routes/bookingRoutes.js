...
const notificationObservers = NotificationFactory.createObservers([
  "email",
  "sms",
]);
...
class CancelBookingController {
  async execute(req, res) {
    try {
      ...
      const booking = await bookingRepository.cancelBooking(
        req.params.id,
        req.user._id,
      );
...
const createBooking = new AuthenticationDecorator(
...
router.delete("/:id", (req, res, next) =>
  cancelBooking.execute(req, res, next),
);
