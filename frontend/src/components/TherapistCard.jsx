...
const TherapistCard = ({ therapist }) => {
  ...
  const renderStars = (rating) => {
    ...
    for (let i = 0; i < fullStars; i++) {
      stars.push(
        <svg key={`full-${i}`} width="16" height="16" className="text-warning" fill="currentColor" viewBox="0 0 20 20">
    ...
    if (hasHalfStar) {
      stars.push(
        <svg key="half" width="16" height="16" className="text-warning" fill="currentColor" viewBox="0 0 20 20">
          <defs>
    ...
    for (let i = 0; i < emptyStars; i++) {
      stars.push(
        <svg key={`empty-${i}`} width="16" height="16" className="text-muted" fill="currentColor" viewBox="0 0 20 20">
          <path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/>
        </svg>
      );
    }
