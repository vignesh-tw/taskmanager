    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-2">{error || 'Therapist not found'}</p>
          <button 
        ...
        <div className="flex flex-col md:flex-row md:items-start gap-6">
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
              <div>
                <h1 className="text-2xl font-bold text-gray-900 mb-2">{therapist.name}</h1>
                <p className="text-lg text-blue-600 font-medium mb-2">{therapist.specialty}</p>
              ...
              <div className="text-right">
                ...
                <div className="text-2xl font-bold text-gray-900">
                  ${therapist.sessionPrice || 100}<span className="text-sm font-normal text-gray-500">/session</span>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      My therapeutic approach is collaborative, client-centered, and evidence-based.
                    </p>
                  </div>
                </div>
              )}
                  ...
                  {therapist.specializations && therapist.specializations.length > 0 ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="flex items-center p-3 bg-blue-50 rounded-lg">
                        ...
                        <span className="text-gray-800">{therapist.specialty}</span>
                      </div>
                    </div>
                  )}
                </div>
                  ...
                  {therapist.education && therapist.education.length > 0 ? (
                      ...
                      <div className="space-y-3">
                        {therapist.education.map((edu, index) => (
                          <div key={index} className="p-4 bg-gray-50 rounded-lg">
                            ...
                            <p className="text-gray-600">{edu.school || 'University'}</p>
                    ...
                    <div>
                      ...
                      <div className="p-4 bg-gray-50 rounded-lg">
                        <h4 className="font-medium text-gray-900">Licensed Clinical Therapist</h4>
                        <p className="text-gray-600">Professional certification and training</p>
                      </div>
                    </div>
                  )}
            ...
            <div className="bg-white rounded-lg shadow-md p-4">
              <div className="mb-4">
                ...
                <div className="text-sm text-gray-600">
                  <p>{new Date(selectedSlot.startTime).toLocaleDateString('en-US', { 
                    weekday: 'long', 
                    year: 'numeric', 
                    month: 'long', 
                    day: 'numeric' 
                  })}</p>
                  <p>{new Date(selectedSlot.startTime).toLocaleTimeString('en-US', {
                    hour: 'numeric',
                    minute: '2-digit',
                    hour12: true
                  })}</p>
              ...
              >
                Book This Session - ${selectedSlot.price || therapist.sessionPrice || 100}
              </button>
            </div>
          )}
        </div>
