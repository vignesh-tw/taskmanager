    ...
    <div className="card shadow-sm mb-4">
      <div className="card-body p-4">
        <form onSubmit={handleSearch}>
          {/* Main Search Bar */}
          <div className="mb-4">
            <label htmlFor="therapist-search" className="form-label fw-semibold mb-2">
              Search Therapists
            </label>
            <div className="input-group input-group-lg">
              <span className="input-group-text bg-light border-end-0">
                <svg width="20" height="20" fill="currentColor" className="bi bi-search text-muted" viewBox="0 0 16 16">
          ...
          <div className="mb-4">
            ...
            <div className="mb-3">
              <label htmlFor="specialty-filter" className="form-label fw-medium mb-2">
                Specialty
              </label>
              <select
                id="specialty-filter"
            ...
            <div className="mb-3">
              <label htmlFor="language-filter" className="form-label fw-medium mb-2">
                Language
              </label>
              <select
                id="language-filter"
            ...
            <div className="mb-4">
              <label htmlFor="location-filter" className="form-label fw-medium mb-2">
                Location
              </label>
              <div className="input-group input-group-lg">
                <span className="input-group-text bg-light">
                  <svg width="20" height="20" fill="currentColor" className="bi bi-geo-alt text-muted" viewBox="0 0 16 16">
            ...
            <div className="d-grid">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <svg width="20" height="20" fill="currentColor" className="bi bi-search me-2" viewBox="0 0 16 16">
                      <path d="m13.498 12.748a.5.5 0 0 1-.707.707l-3.293-3.293a6.002 6.002 0 1 1 .707-.707l3.293 3.293zM6.5 12A5.5 5.5 0 1 0 6.5 1a5.5 5.5 0 0 0 0 11z"/>
                    </svg>
                    Find Therapists
                  </>
          ...
          {hasActiveFilters && (
            <div className="d-flex justify-content-between align-items-center pt-2 border-top">
              <small className="text-muted">
                {Object.values(filters).filter(v => v).length + (searchTerm ? 1 : 0)} filter(s) active
              </small>
              <button
                type="button"
