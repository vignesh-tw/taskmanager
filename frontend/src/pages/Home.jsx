  ...
  const features = [
    {
      ...
      description: 'Find the perfect therapist using our advanced search filters by specialty, language, location, and more.',
      color: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'
    },
    {
      icon: <Schedule sx={{ fontSize: 48, color: 'white' }} />,
      title: 'Real-Time Booking',
      description: 'See live availability and book sessions instantly with our interactive calendar system.',
      color: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)'
    },
    {
      icon: <Security sx={{ fontSize: 48, color: 'white' }} />,
      title: 'Secure & Private',
      description: 'Your mental health journey is completely confidential with enterprise-grade security.',
      color: 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)'
    },
    {
      icon: <CheckCircleRounded sx={{ fontSize: 48, color: 'white' }} />,
      title: 'Verified Professionals',
      description: 'All therapists are licensed, verified, and committed to providing quality mental healthcare.',
  ...
  return (
    <>
      ...
      >
        ...
        <div className="container position-relative" style={{ zIndex: 1, maxWidth: '1400px' }}>
          <Row className="align-items-center g-5">
            <Col xs={12} lg={7} xl={6}>
              <h1 className="display-1 fw-bold mb-4 lh-1" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)' }}>
                Your Mental Health Journey Starts Here
              </h1>
              <p className="lead mb-4" style={{ opacity: 0.9, fontSize: 'clamp(1.1rem, 2vw, 1.5rem)' }}>
                Connect with licensed therapists, book sessions instantly, and take control of your wellbeing with our comprehensive mental health platform.
              </p>
                ...
                {!isAuthenticated ? (
                  ...
                  <div>
                    ...
                    <Button
                      variant="light"
                      size="lg"
                      onClick={() => navigate(user.userType === 'therapist' ? '/therapist/dashboard' : '/therapists')}
                      className="fw-bold px-4 py-2 d-flex align-items-center gap-2"
                    >
                      <ArrowForwardRounded />
                      {user.userType === 'therapist' ? 'Go to Dashboard' : 'Find Therapists'}
                    </Button>
                  </div>
                )}
              </div>
              ...
              <div className="d-flex justify-content-center justify-content-lg-end">
                ...
                >
                  <Card.Body className="p-5">
                    <h4 className="fw-bold mb-4 text-white" style={{ fontSize: '1.5rem' }}>Quick Search</h4>
                    ...
                    <div className="mt-3">
                      ...
                      <div className="d-flex gap-3 flex-wrap">
                        {['Anxiety', 'Depression', 'CBT', 'Couples Therapy'].map((specialty) => (
                          <Badge 
                            key={specialty}
                            bg="light"
                            text="dark"
                            ...
                            onClick={() => handleSearch({ specialization: specialty })}
                          >
                            {specialty}
                          </Badge>
                        ))}
      ...
      <div className="container-fluid">
        ...
        <section className="mb-5">
          ...
          <Row className="g-4 justify-content-center">
            {features.map((feature, index) => (
              <Col xs={12} sm={6} lg={3} xl={3} xxl={2} key={index} className="d-flex">
                <Card
                ...
                >
                  <Card.Body className="d-flex flex-column justify-content-center p-4">
                    ...
                    <p className="mb-0 flex-grow-1 d-flex align-items-center" style={{ opacity: 0.9 }}>
                      {feature.description}
                    </p>
                  </Card.Body>
                </Card>
        ...
        <section className="mb-5">
          <div className="text-center mb-5">
            <h2 className="display-4 fw-bold mb-3">
              {hasSearched ? 'Search Results' : 'Meet Our Featured Therapists'}
            </h2>
          ...
          {loading ? (
            ...
            <>
              <Row className="g-4 justify-content-center">
                {(hasSearched ? searchResults : therapists).map((therapist) => (
                  <Col xs={12} sm={6} lg={4} xl={4} xxl={3} key={therapist.id} className="d-flex">
                    <div className="w-100">
              ...
              {(hasSearched && searchResults.length === 0) && (
                <div className="text-center py-5">
                  ...
                  <p className="text-muted mb-4">
                    Try adjusting your search filters or browse all available therapists.
                  </p>
        ...
        <section className="py-5 bg-light rounded-4 mb-5">
          ...
          <Row className="g-4 justify-content-center">
            {testimonials.map((testimonial, index) => (
              <Col xs={12} md={6} lg={4} xl={4} xxl={3} key={index} className="d-flex">
                      ...
                      <div>
                        ...
                        <div className="d-flex">
                          {[...Array(testimonial.rating)].map((_, i) => (
                            <StarRounded key={i} className="text-warning" style={{ fontSize: '18px' }} />
                          ))}
                        </div>
                      </div>
                    </div>
        ...
        {!isAuthenticated && (
          ...
          >
            ...
            <div className="position-relative" style={{ zIndex: 1 }}>
              ...
              <p className="lead mb-4 mx-auto" style={{ opacity: 0.9, maxWidth: '600px' }}>
                Join thousands of users who have transformed their mental health with our platform
              </p>
